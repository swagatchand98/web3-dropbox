...
export default function AuthenticatedDashboard() {
  ...
  const handleFileUpload = useCallback(async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setTimeout(() => {
      ...
      // Phase 2: Show splitting animation for 4 seconds, then start actual upload
      setTimeout(async () => {
            ...
            <div className="text-center">
              ...
              {uploadAnimation.phase === 'splitting' && (
                ...
                >
                  ...
                  >
                    {/* Multi-directional splitting animation with enhanced off-screen movement */}
                    {/* Top chunk */}
                    <motion.div
                    ...
                    >
                      <motion.div 
                        className="w-8 h-8 bg-gradient-to-r from-purple-500 to-cyan-400 rounded-full flex items-center justify-center shadow-xl"
                        animate={{
                          boxShadow: [
                    ...
                    >
                      <motion.div 
                        ...
                        transition={{ duration: 4, times: [0, 0.3, 0.7, 1], delay: 0.3 }}
                      >
                        <Lock className="w-4 h-4 text-white" />
                      </motion.div>
                    </motion.div>
                    ...
                    >
                      <motion.div 
                        ...
                        transition={{ duration: 4, times: [0, 0.3, 0.7, 1], delay: 0.6 }}
                      >
                        <Lock className="w-4 h-4 text-white" />
                      </motion.div>
                    </motion.div>
                    ...
                    >
                      <motion.div 
                        ...
                        transition={{ duration: 4, times: [0, 0.3, 0.7, 1], delay: 0.9 }}
                      >
                        <Lock className="w-4 h-4 text-white" />
                      </motion.div>
                    </motion.div>
                    ...
                    <motion.div
                      ...
                      animate={{
                        x: [0, 120, 300, 550],
                        y: [0, -120, -300, -550],
                        scale: [1, 0.7, 0.2, 0.02],
                        opacity: [1, 0.8, 0.3, 0],
                        rotate: [0, 135, 360, 540]
                      }}
                      transition={{
                        duration: 4,
                        ease: [0.25, 0.46, 0.45, 0.94],
                    ...
                    >
                      <motion.div 
                        className="w-6 h-6 bg-gradient-to-r from-purple-500 to-cyan-400 rounded-full flex items-center justify-center shadow-lg"
                        animate={{
                          boxShadow: [
                    ...
                    >
                      <motion.div 
                        ...
                        transition={{ duration: 4, times: [0, 0.3, 0.7, 1], delay: 0.5 }}
                      >
                        <Lock className="w-3 h-3 text-white" />
                      </motion.div>
                    </motion.div>
                    ...
                    <motion.div
                      ...
                      animate={{
                        x: [0, -100, -250, -450],
                        y: [0, -100, -250, -450],
                        scale: [1, 0.6, 0.15, 0.01],
                        opacity: [1, 0.7, 0.2, 0],
                        rotate: [0, 225, 540, 810]
                      }}
                      transition={{
                        duration: 4,
                        ease: [0.25, 0.46, 0.45, 0.94],
                    ...
                    >
                      <motion.div 
                        className="w-5 h-5 bg-gradient-to-r from-purple-500 to-cyan-400 rounded-full flex items-center justify-center shadow-md"
                        animate={{
                          boxShadow: [
                        ...
                        transition={{ duration: 4, times: [0, 0.3, 0.7, 1], delay: 0.1 }}
                      >
                    ...
                    >
                      <motion.div 
                        ...
                        transition={{ duration: 4, times: [0, 0.3, 0.7, 1], delay: 0.7 }}
                      >
                        <Lock className="w-2.5 h-2.5 text-white" />
                      </motion.div>
                    </motion.div>
